...
echo Stuffs &&
sleep 1 &&
sudo pacman -Syu --noconfirm base-devel git wget multilib-devel cmake svn clang lzip patchelf inetutils python2-distlib discord firefox xorg xorg-xinit cowsay exa noto-fonts noto-fonts-emoji qbittorrent gamemode vlc repo libappindicator-gtk2 libappindicator-gtk3 lib32-libappindicator-gtk3 lib32-libappindicator-gtk2 gnome-shell-extension-appindicator lutris android-tools android-udev &&
echo Wine ;
sleep 1 ;

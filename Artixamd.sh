...
#shit
sudo pacman -S steam gamemode lib32-gamemode gamemodeswitch gvfs-mtp fuse transmission-gtk libreoffice-fresh 
#paru
...
paru -Syyy matcha-gtk-theme-git protontricks-git librewolf-bin lutris-git papirus-icon-theme-git android-udev-git android-sdk-platform-tools openrgb-git qogir-icon-theme-git ; 
echo fin

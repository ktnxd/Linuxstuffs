...
#shit
sudo pacman -S steam gamemode lib32-gamemode gvfs-mtp fuse transmission-gtk mpv
#paru
...
#AUR shit
paru -Syyy matcha-gtk-theme-git protontricks-git librewolf-bin lutris exa papirus-icon-theme-git brave-bin ; 
echo fin
